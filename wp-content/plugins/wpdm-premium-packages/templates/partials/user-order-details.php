...
LIC;
                        ...
                        <td class='text-right wpdmpp-amount-col' align='right'><?php echo WPDMPP()->order->itemCost($item, true); ?></td>
...
SPEC;
                ...
                <tr class="item hidden-xs">
                    ...
                    <td class='text-right wpdmpp-amount-col' ><b><?php echo wpdmpp_price_format($order->subtotal); ?></b></td>
                    <?php if ($order->order_status == 'Completed') { ?>
                        <td>&nbsp;</td>
                    <?php } ?>
                </tr>
                <tr class="item hidden-xs">
                    ...
                    <td class='text-right wpdmpp-amount-col' align='right'><b>- <?php echo wpdmpp_price_format($order->coupon_discount); ?></b></td>
                    <?php if ($order->order_status == 'Completed') { ?>
                        <td>&nbsp;</td>
                    <?php } ?>
                </tr>
                <tr class="item hidden-xs">
                    ...
                    <td class='text-right wpdmpp-amount-col' align='right'><b>+ <?php echo wpdmpp_price_format($order->tax); ?></b></td>
                    <?php if ($order->order_status == 'Completed') { ?>
                        <td>&nbsp;</td>
                    <?php } ?>
                </tr>
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <?php echo $order->auto_renew == 1?'Next Renew':'Expiry'; ?> Date <span class="badge badge-secondary"><?php echo wp_date(get_option('date_format'),  $order->expire_date); ?></span>
    ...
    <div class="row">
        <div class="col-md-<?= ($order->auto_renew === 1) ? 4 : 6 ?>">
            <div class="card">
