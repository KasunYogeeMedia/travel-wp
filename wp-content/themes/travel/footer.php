            ...
            <div class="col-sm-12 col-md-3 col-lg-3">
                <div class="s-1">
                    <div class="social-lofo-des">
                        ...
                        <img src="<?php echo get_template_directory_uri(); ?>/inc/img/payments.png" alt=""
                            class="payment-image">
                ...
                <div class="s-1">
                    ...
                    <div class="social">
                        <ul>
                            ...
                            <li>
                                <p><a href="<?php the_permalink(); ?>" class="text-muted"><i
                                            class="fas fa-globe"></i><?php the_title(); ?></a></p>
                            </li>
                            <?php endwhile;
								wp_reset_postdata(); ?>
                            <?php else :  ?>
            ...
            <div class="col-sm-12 col-md-3 col-lg-3">
				...
				<p class="p-13">Wijeya Road, Gampaha</p> -->
                        <ul>
                            ...
                            <?php if ($email) : ?>
                            <li>
                                <p><a class="text-muted" href="mailto:<?php echo $email; ?>"><i
                                            class="far fa-envelope"></i><span><?php echo $email; ?></span></a></p>
                            </li>
                            <?php endif; ?>
                            <?php
                            ...
                            <?php if ($mobile_no) : ?>
                            <li>
                                <p><a href="tel:<?php echo $mobile_no; ?>" class="text-muted"><i
                                            class="fas fa-phone"></i><span><?php echo $mobile_no; ?></span></a></p>
                            </li>
                            <?php endif; ?>
                            <?php
                            ...
                            <?php if ($land_number) : ?>
                            <li>
                                <p><a href="tel:<?php echo $land_number; ?>" class="text-muted"><i
                                            class="fas fa-fax"></i><span><?php echo $land_number; ?></span></a></p>
                            </li>
                            <?php endif; ?>
                        </ul>
                    </div>
