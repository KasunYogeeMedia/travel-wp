...
$item_table         = <<<OTH
	...
	$billing_info['phone'] = $billing_info['phone'] ? "<div id='phone'>Phone: {$billing_info['phone']}</div>" : '';
	$billing_info['taxid'] = $billing_info['taxid'] ? "<div id='phone'>Phone: {$billing_info['taxid']}</div>" : '';
                ...
                <div class="row gx-0">
                    ...
                    <div class="col-sm-4 ms-auto">
                        <div class="invoice-id my-4 px-4  position-relative">
                            <h1 class="mb-1 text-accent">INVOICE</h1>
                            <p>#<?= $order->order_id ?></p>
                            <p>Date: <?php echo wp_date(get_option('date_format'),$order->date); ?></p>
                        ...
                        <div class="row">
                            <div class="col pt-5 text-center align-self-end">
                               ...
                               <div class="sign mx-auto">
                                ...
                                <h6 class="text-center pt-3 mt-3 border-top mb-4">AUTHORIZED SIGN</h6>
                               </div>
                                <?php } ?>
                            </div>
                            <div class="col">
