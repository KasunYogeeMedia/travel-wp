...
<script>
    jQuery(function($){
        $('a[data-toggle="tab"]').on('show.bs.tab', function(e) {
            ...
            }, "", "edit.php?post_type=wpdmpro&page=settings&tab=ppsettings&ppstab=" + $(e.target).data('pptab'));
        });
        ...
        if(wppmsta){
            ...
            window.history.pushState({
                "html": $('#wpbody-content').html(),
                "pageTitle": "response.pageTitle"
            }, "", "edit.php?post_type=wpdmpro&page=settings&tab=ppsettings&ppstab=" + wppmsta.replace('#', ''));
        }
    });
</script>