    ...
    <div class="row">
        <div class="col-md-5">
            <div class="input-group input-group-asyoupay">
                ...
                <input name="iwantopay" type="text" placeholder="<?php echo wpdmpp_product_price($product_id); ?>" step="0.01" min="<?php echo wpdmpp_product_price($product_id); ?>" value="<?php echo wpdmpp_product_price($product_id); ?>" class="form-control iwanttopay text-center" readonly>
            </div>
        </div>
        <div class="col-md-3">
